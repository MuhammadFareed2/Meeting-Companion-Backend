...
const uploadMeetingService = (filePath, userId, body) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return new Promise((resolve, reject) => {
        ...
        (0, fluent_ffmpeg_1.default)(filePath)
            ...
            try {
                const result = yield cloudinary_1.default.uploader.upload(outputPath, {
                    resource_type: "video",
                    folder: "converted-audio",
                    public_id: path_1.default.parse(outputFilename).name,
                });
                fs_1.default.unlinkSync(outputPath);
                const dbResult = yield (0, upload_1.default)(result.secure_url, userId, body);
                resolve(dbResult);
            }
            catch (err) {
